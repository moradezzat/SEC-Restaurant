            ...
            <div className="fixed top-0 left-0 w-full h-full bg-black/70 flex z-[48] transition-all duration-300 ease" onClick={onClose} />
                <div className={`Sidenav fixed top-[68px] right-[0%] w-[300px] h-full bg-white z-[49] transition-all duration-300 ease shadow-md flex flex-col dark:bg-[#1E1E1E] ${ isClosing ? 'animate-slideOutFromLeft' : 'animate-slideInFromRight' }`}>
                    ...
                    <div className="p-6 overflow-y-auto flex-1">
                        <div className="mb-8">
                            <h3 className="m-0 mb-4 text-[#2c3e50] text-[1.1rem] dark:text-[#CCCCCC]">Language</h3>
                            <select
                                className="w-full p-[0.8rem] border-[1px] border-[#dddddd] rounded-[5px] text-[1rem] text-[#2c3e50] bg-white dark:bg-[#1E1E1E] dark:border-[#5c5c5c] dark:text-white transition-all duration-300 ease"
                                value={language} 
                        ...
                        <div className="mb-8">
                            ...
                            <div className="flex gap-4 mt-4">
                                ...
                                <button 
                                    className={`flex-1 p-[0.8rem] border-[1px] border-b-[#dddddd] rounded-[5px] text-[1rem] text-[#2c3e50] cursor-pointer transition-all duration-300 ease hover:border-[#e74c3c] hover:text-[#e74c3c] ${selectedMode === 'dark' ? 'bg-[#e74c3c] text-white border-none hover:text-white' : 'bg-white text-[#2c3e50] border-[#dddddd]'}`}
