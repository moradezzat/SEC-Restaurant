                ...
                <div className="hidden lg:grid lg:grid-cols-2 lg:gap-8">
                    ...
                    <div className="flex flex-col items-center text-center justify-center ml-80">
                        ...
                        <div className="flex gap-[0.8rem] justify-center">
                            <a href="https://www.tiktok.com/@maryemahmed00" target="_blank" className="w-[35px] h-[35px] rounded-[50%] bg-[#34495e] dark:bg-[#363b41] flex items-center justify-center text-white no-underline transition-all duration-300 ease hover:bg-[#e74c3c] hover:scale-[1.1] will-change-transform">
                                <FontAwesomeIcon icon={faTiktok} size="lg"/>
                            </a>
                            <a href="https://www.facebook.com/marium8485" target="_blank" className="w-[35px] h-[35px] rounded-[50%] bg-[#34495e] dark:bg-[#363b41] flex items-center justify-center text-white no-underline transition-all duration-300 ease hover:bg-[#e74c3c] hover:scale-[1.1] will-change-transform">
                                <FontAwesomeIcon icon={faFacebookF} size="lg"/> 
                            </a>
                            <a href="https://instagram.com/sett.el.kol?igsh=MWJuZzdmNGU3NWhzMA==" target="_blank" className="w-[35px] h-[35px] rounded-[50%] bg-[#363b41] dark:bg-[#3d444b] flex items-center justify-center text-white no-underline transition-all duration-300 ease hover:bg-[#e74c3c] hover:scale-[1.1] will-change-transform">
                                <FontAwesomeIcon icon={faInstagram} size="lg"/>
                            </a>
                            <a href="https://chat.whatsapp.com/Hnh0Ueh42eJLnKrhlcAEQs" target="_blank" className="w-[35px] h-[35px] rounded-[50%] bg-[#34495e] dark:bg-[#363b41] flex items-center justify-center text-white no-underline transition-all duration-300 ease hover:bg-[#e74c3c] hover:scale-[1.1] will-change-transform">
                    ...
                    <div className="grid grid-cols-2 gap-8">
                        ...
                        <div className="flex flex-col items-center text-center justify-center ml-52">
                            ...
                            <div className="flex gap-[0.8rem] justify-center">
                                ...
                                <a href="https://instagram.com/sett.el.kol?igsh=MWJuZzdmNGU3NWhzMA==" target="_blank" className="w-[35px] h-[35px] rounded-[50%] bg-[#34495e] dark:bg-[#363b41] flex items-center justify-center text-white no-underline transition-all duration-300 ease hover:bg-[#e74c3c] hover:scale-[1.1] will-change-transform">
                                    <FontAwesomeIcon icon={faInstagram} size="lg"/>
                                </a>
                                <a href="https://chat.whatsapp.com/Hnh0Ueh42eJLnKrhlcAEQs" target="_blank" className="w-[35px] h-[35px] rounded-[50%] bg-[#34495e] dark:bg-[#363b41] flex items-center justify-center text-white no-underline transition-all duration-300 ease hover:bg-[#e74c3c] hover:scale-[1.1] will-change-transform">
                                    <FontAwesomeIcon icon={faWhatsapp} size="lg"/>
                ...
                <div className="block md:hidden">
                    <div className="flex flex-col items-center text-center space-y-4">
                        ...
                        <div className="flex gap-[0.6rem] justify-center">
                            <a href="https://www.tiktok.com/@maryemahmed00" target="_blank" className="w-[32px] h-[32px] rounded-[50%] bg-[#34495e] dark:bg-[#363b41] flex items-center justify-center text-white no-underline transition-all duration-300 ease hover:bg-[#e74c3c] hover:scale-[1.1]">
                                <FontAwesomeIcon icon={faTiktok} size="sm"/>
                            </a>
                            <a href="https://www.facebook.com/marium8485" target="_blank" className="w-[32px] h-[32px] rounded-[50%] bg-[#34495e] dark:bg-[#363b41] flex items-center justify-center text-white no-underline transition-all duration-300 ease hover:bg-[#e74c3c] hover:scale-[1.1]">
                                <FontAwesomeIcon icon={faFacebookF} size="sm"/> 
                            </a>
                            <a href="https://instagram.com/sett.el.kol?igsh=MWJuZzdmNGU3NWhzMA==" target="_blank" className="w-[32px] h-[32px] rounded-[50%] bg-[#34495e] dark:bg-[#363b41] flex items-center justify-center text-white no-underline transition-all duration-300 ease hover:bg-[#e74c3c] hover:scale-[1.1]">
                                <FontAwesomeIcon icon={faInstagram} size="sm"/>
                            </a>
                            <a href="https://chat.whatsapp.com/Hnh0Ueh42eJLnKrhlcAEQs" target="_blank" className="w-[32px] h-[32px] rounded-[50%] bg-[#34495e] dark:bg-[#363b41] flex items-center justify-center text-white no-underline transition-all duration-300 ease hover:bg-[#e74c3c] hover:scale-[1.1]">
